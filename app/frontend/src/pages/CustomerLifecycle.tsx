...
export default function CustomerLifecycle() {
  ...
  const reconcileClosure = async (customer: LifecycleCustomer) => {
    ...
    try {
      ...
      toast.success(`闭环完成：停止项目 ${summary.stopped_projects || 0} 个，关闭续费 ${summary.stopped_subscriptions || 0} 条`);
      await loadData();
    } catch (err: any) {
