...
export const defaultBusinessDictConfig: BusinessDictConfig = {
  ...
  customerPackages: 'google_business_management:Google商家管理,facebook_business_management:Facebook商家管理,instagram_business_management:Instagram商家管理,yelp_business_management:Yelp商家管理,tiktok_business_management:Tiktok商家管理,xiaohongshu_management:小红书管理,x_business_management:X商家管理',
  ...
  subscriptionStatuses: 'active:正常,expiring_soon:即将到期,renewal_pending:待扣款确认,expired:已到期,renewed:已续费,paused:暂停,lost:流失',
...
export function buildBusinessDicts(config = loadDictConfig()): BusinessDictMaps {
  ...
  return {
    ...
    customerPackages: { ...coreCustomerPackageLabels, ...parseDictEntries(normalized.customerPackages) },
