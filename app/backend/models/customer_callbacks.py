...
class Customer_callbacks(Base):
    ...
    created_by_employee_name = Column(String, nullable=True)
    completed_by_employee_id = Column(Integer, nullable=True)
    completed_by_employee_name = Column(String, nullable=True)
